Shader "Nature Shaders/Vegetation"
{
    Properties
    {
        // Transparency
    ...
    SubShader
    {
        ...
        #pragma surface NatureShaderSurface StandardCustom fullforwardshadows vertex:NatureShaderVertex keepalpha addshadow nolightmap
        ...
        // Keywords
        #pragma multi_compile _WIND_CONTROL_BAKED _WIND_CONTROL_UV _WIND_CONTROL_VERTEX
        //#pragma shader_feature _DEBUG_AMBIENT _DEBUG_GUST _DEBUG_TURBULENCE _DEBUG_NONE
        #pragma multi_compile _COLOR_HSL _COLOR_TINT
        #pragma multi_compile _SURFACE_MAP_METALLIC_GLOSS _SURFACE_MAP_MASK
        ...
        #define PROPERTY_WindFade
        #define PROPERTY_ScaleFade
