Shader "Nature Shaders/Tree Billboard"
{
    ...
    SubShader
    {
        ...
        #pragma surface NatureShaderSurface StandardCustom fullforwardshadows vertex:NatureShaderVertex keepalpha addshadow nolightmap dithercrossfade nodirlightmap nodynlightmap
